#!/usr/bin/env bash
# Score the four A02 meshes against held-out photographs, inside a GPU allocation.
#
...
MASKS="${MASKS:-$MILO_ROOT/masks_A02_und_object/colmap}"
CAPTURE="$MILO_ROOT/data/17062025/A02/capture.json"
OUT="${OUT:-$MILO_ROOT/output/17062025/A02/silhouette}"
...
echo "=== silhouette comparison, A02, $(date) on $(hostname) ==="
