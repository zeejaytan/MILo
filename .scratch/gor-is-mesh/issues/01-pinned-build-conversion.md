...
- 2026-09-18 (laptop): convert resume submitted as CPU job + gtracer/reuse smoke submitted as GPU job — SUBMITTED after ssh recovery: convert `30715195`, smoke `30715196`. Laptop-side polls running on both per workspace rule 4; final `sacct` State/ExitCode to follow here. Nothing trains in this ticket.
